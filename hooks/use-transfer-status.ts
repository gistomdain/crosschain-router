...
export function useTransferStatus(provider?:string,txHash?:string){const [data,setData]=useState<TransferStatus|null>(null);const [error,setError]=useState<string>();
