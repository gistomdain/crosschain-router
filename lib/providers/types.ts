...
export type NormalizedQuote={id:string;provider:string;receive:string;feeUsd?:number;etaSeconds?:number;steps:string[];expiresAt?:string;approvalTxs?:ProviderTransaction[];tx?:ProviderTransaction;raw?:unknown};
