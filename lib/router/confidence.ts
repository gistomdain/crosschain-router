...
{key:"provider",label:"Provider response",state:!provider?"unknown":provider.status==="healthy"?"good":provider.status==="slow"?"caution":"unknown",detail:!provider?"No telemetry":provider.status==="unavailable"?(provider.reason==="timeout"?"Timed out":provider.reason==="no-route"?"No route returned":"Provider error"):provider.latencyMs+"ms · "+provider.status},
